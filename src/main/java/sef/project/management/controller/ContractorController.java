...
public class ContractorController {
	...
	@GetMapping(path = "/addrate")
	public @ResponseBody ContractorDTO getAddRate(@RequestParam Integer userId, @RequestParam Integer weeks,
			@RequestParam Integer rate) {
		return contractorService.getAddRate(userId, weeks, rate);
	}
